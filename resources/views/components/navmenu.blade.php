                ...
                <ul class="flex items-center gap-9 text-sm font-principal pt-3 text-[19px] tracking-wide text-[#4C555C]">
                    ...
                    <li class="relative group">
                        ...
                        <ul
                            ...
                            <li>
                                <a href="{{ url('/#analisis') }}" class="block px-4 py-2 hover:bg-gray-100">
                                    Análisis por ámbitos
                                </a>
                            </li>

                            <li>
                                <a href="https://retodemografico.sitcan.es/" target="_blank"
                    ...
                    <li>
                        <a href="https://ovrd.org/" target="_blank"
                            class="relative py-2 text-[#1F2124] transition
                            after:absolute after:left-1/2 after:-translate-x-1/2 after:bottom-0 after:h-[1px] after:w-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">
                            Oficina Virtual
                        </a>
                    ...
                    <li>
                        <a href="https://congresoretodemograficogobcan.org/" target="_blank"
                            class="relative py-2 text-[#1F2124] transition
                            after:absolute after:left-1/2 after:-translate-x-1/2 after:bottom-0 after:h-[1px] after:w-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">
    ...
    <ul class="flex flex-col divide-y">
        ...
        <li>
            ...
            <div class="hidden flex flex-col">
                <a class="px-6 py-2 hover:bg-gray-100" href="{{ url('/observatorio#analisis') }}">Análisis por
                    ámbitos</a>
                <a class="px-6 py-2 hover:bg-gray-100" target="_blank"
                    href="https://retodemografico.sitcan.es/">Visor</a>
            </div>
        </li>
        ...
        <li><a class="block px-4 py-3 hover:bg-gray-100" href="{{ url('/observatorio#estrategia') }}">Estrategia</a>
        </li>
        ...
        <li>
            ...
            <div class="hidden flex flex-col">
                ...
                <a class="px-6 py-2 hover:bg-gray-100"
                    href="{{ url('/actualidad#experienciasrealizadas') }}">Experiencias realizadas</a>
                <a class="px-6 py-2 hover:bg-gray-100" href="{{ url('/actualidad#enlacesdeinteres') }}">Enlaces de
                    interés</a>
                <a class="px-6 py-2 hover:bg-gray-100" href="{{ url('/actualidad#actividades') }}">Actividades</a>
            </div>
        </li>

        <li><a class="block px-4 py-3 hover:bg-gray-100" target="_blank" href="https://ovrd.org">Oficina Virtual</a>
        </li>

        <li><a class="block px-4 py-3 hover:bg-gray-100" target="_blank"
                href="https://congresoretodemograficogobcan.org/">I Congreso Reto Demográfico</a></li>
