<div>
    ...
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-xl font-semibold">Listado de Subtemáticas</h2>
    ...
    <table class="w-full border border-gray-200 rounded-lg overflow-hidden mb-6">
        <thead class="bg-gray-100">
            <tr>
                ...
                <th class="text-left p-3">Temática</th>
            ...
            <tr class="border-t {{ in_array($subtheme->id, $trashedIds) ? 'bg-red-50' : '' }}">
                ...
                <td class="p-3 space-x-2">
                    ...
                    @if(in_array($subtheme->id, $trashedIds))
                        <button wire:click="restore({{ $subtheme->id }})"
                                class="text-green-600 hover:underline">Restaurar</button>
                    @else
                        <button wire:click="confirmDelete({{ $subtheme->id }})"
    ...
    <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
        <div class="bg-white rounded-xl w-96 p-6">
            <h3 class="text-lg font-semibold mb-4">
                {{ $subtheme_id ? 'Editar Subtemática' : 'Nueva Subtemática' }}
            </h3>

            <input type="text" wire:model="name" placeholder="Nombre de la subtemática"
    ...
    <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
        <div class="bg-white rounded-xl w-96 p-6 text-center">
            ...
            <h3 class="text-lg font-semibold mb-2">¿Seguro que desea eliminar esta subtemática?</h3>
